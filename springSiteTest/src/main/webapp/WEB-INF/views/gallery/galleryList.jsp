...
<script type="text/javascript">
	$(function() {
		...
		//newRecord("홍길동","갤러리 게시판 제목","게시판 내용", "thumb-01.jpg", "thumb-01.jpg", "2017-11-14", 0);
		listData();
	...
	function newRecord(g_name, g_subject, g_content, g_thumb, g_file, g_date,
		...
		//메소드 확인 시 아래 경로로 확인
		/* lightbox_a.attr({
				"href" : "/resources/images/thumbnail/" + g_file,
						...
						<form id="f_writeForm" name="f_writeForm">
							<div class="form-group">
								<label for="g_name" class="control-label">작성자</label> <input
									type="text" class="corm-control" name="g_name" id="g_name"
									maxlength="5" />
							</div>
							<div class="form-group">
